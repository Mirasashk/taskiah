...
import TaskEditDiaglog from '../components/task/TaskEditDialog';
        ...
        <Card.Content>
          ...
          <View style={{gap: 10}}>
            <View
              ...
              <Text onPress={() => setShowStatus(true)} style={{}}>
            ...
            <View
              ...
              <Text onPress={() => setShowPriority(true)} style={{}}>
            ...
            <View
              ...
              <Text
                ...
                {taskState.category ? taskState.category : 'Add category'}
              </Text>
            </View>
            <View
              style={{
